...
public class BuzzersAllTest extends BuzzersTestBase {
    ...
    public void testFIZZ(){
        ...
        // when
        List<Integer> expectedIndexList = Arrays.asList(3, 6, 9, 12, 15, 18, 21, 24, 27, 30, 33, 36, 39);
        List<Integer> expectedIndexList2 = Arrays.asList(99, 102, 105, 108, 111, 114, 117, 120);

        // then: Print Fizz for every index divisible by 3. Otherwise the empty string
        assertResults(buzzer, expectedIndexList);
        assertResults(buzzer, expectedIndexList2);
    }
    ...
    public void testBUZZ() {
        ...
        // when
        List<Integer> expectedIndexList = Arrays.asList(5, 10, 15, 20, 25, 30, 35, 40, 45, 50);
        List<Integer> expectedIndexList2 = Arrays.asList(95, 100, 105, 110, 115);
    ...
    public void testWOOF() {
        ...
        // when
        List<Integer> expectedIndexList = Arrays.asList(7, 14, 21, 28, 35, 42, 49);
        List<Integer> expectedIndexList2 = Arrays.asList(70, 77, 84, 91, 98, 105, 112);
    ...
    public void testFOO() {
        ...
        // when
        List<Integer> expectedIndexList = Arrays.asList(11, 22, 33, 44, 55, 66, 77, 88, 99, 111, 222, 333, 444, 555, 666, 777, 888, 999, 1111, 2222);
    ...
    public void testSUMO(){
        ...
        // when
        List<Integer> expectedIndexList = Arrays.asList(12, 14, 16, 18, 21, 23, 25, 27, 29, 30);
        List<Integer> expectedIndexList2 = Arrays.asList(96, 98, 100, 102, 104, 106, 108, 111);
    ...
    public void testHALO(){
        ...
        // when
        List<Integer> expectedIndexList = Arrays.asList(8, 18, 24, 28, 38, 42, 44, 46, 48, 58);
